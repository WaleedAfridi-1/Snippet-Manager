  ...
  return (
    <div className='flex flex-col gap-10 relative'>
      <div className='flex justify-between'>
        <h1 className='text-xl font-bold line-clamp-1 md:text-3xl  lg:text-5xl'>{snippet.title}</h1>
        <div className='lg:flex  grid grid-cols-1 gap-4 lg:gap-5 items-center justify-center'>
            ...
            <Link href={`/snippet/${snippet.id}/edit`}>
                <Button className='px-6 py-4 tracking-wider font-bold cursor-pointer lg:text-xl lg:py-5 ml-5 lg:ml-0'>Edit</Button>
            </Link>
        </div>
      </div>
